...
public:
    ...
    void balance(int sortDecId = 1, bool updateLevel = false);
    void rewrite(bool fUseZeros = false, bool fGPUDeduplicate = false, bool fOptimizeLevel = false);
