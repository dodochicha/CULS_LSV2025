...
class AbcInterface
{
    public:
        ...
        /// @brief Execute a raw ABC command string (for compatibility with scripts using abc_command)
        /// @param command The ABC command to run (e.g., "read_aig foo.aig; strash")
        /// @return true if successful
        bool abc_command(const std::string &command);
        /*------------------------------*/ 
        /* Take actions                 */
        /*------------------------------*/ 
